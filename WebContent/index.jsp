	...
	<div class="card-body">
		...
		<div class="row">
			...
			<div class="col-3 text-right">
				<a onclick="return confirm('추천하시겠습니다?')" href="./likeAction.jsp?evaluationID=">추천</a>
				<a onclick="return confirm('삭제하시겠습니다?')" href="./deleteAction.jsp?evaluationID=">삭제</a>
			</div>
...
Copyright &copy; 2020 나동빈 All Rights Reserved.
</footer>
<script src="./js/jquery.min.js"></script>
<script src="./js/poooper.js"></script>
